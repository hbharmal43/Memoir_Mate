...
public class AddFriend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        friend_email = findViewById(R.id.friend_em);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String getFrEm = friend_email.getText().toString();

                Map<String, String> info = new HashMap<>();
                info.put("user_email", getUsEm);
                info.put("relative_email", getFrEm);
                FirebaseFirestore.getInstance().collection("FriendsLink").document().set(info).addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
